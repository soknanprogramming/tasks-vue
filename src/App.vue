...
import bg from '@/assets/wp5234116.jpg'
...
<template>
  <div>
    <div class="fixed inset-0 -z-10 bg-cover bg-center"
      :style="showBackgroundImageStore.show ? { backgroundImage: `url(${bg})` } : {}"></div>
    <div class="p-2">
